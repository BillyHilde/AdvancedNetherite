...
public class ModItemTagsProvider extends ItemTagsProvider
{
    ...
    protected void addTags(HolderLookup.Provider lookupProvider)
    {
        ...
        tag(ModTags.NETHERITE_BLOCKITEMS)
                .add(ModBlocks.NETHERITE_IRON_BLOCK.asItem().builtInRegistryHolder().key())
                .add(ModBlocks.NETHERITE_GOLD_BLOCK.asItem().builtInRegistryHolder().key())
                .add(ModBlocks.NETHERITE_EMERALD_BLOCK.asItem().builtInRegistryHolder().key())
                .add(ModBlocks.NETHERITE_DIAMOND_BLOCK.asItem().builtInRegistryHolder().key());
        ...
        tag(ModTags.HOE_NETHERITE).add(ItemIds.NETHERITE_HOE);
        ...
        tag(ModTags.INGOTS_NETHERITES).add(ItemIds.NETHERITE_INGOT);
        ...
        tag(ModTags.LEGGINGS_NETHERITE).add(ItemIds.NETHERITE_LEGGINGS);
        ...
        tag(ModTags.PICKAXE_NETHERITE).add(ItemIds.NETHERITE_PICKAXE);
        ...
        tag(ModTags.SHOVEL_NETHERITE).add(ItemIds.NETHERITE_SHOVEL);
        ...
        tag(ModTags.SWORD_NETHERITE).add(ItemIds.NETHERITE_SWORD);
        ...
        tag(ModTags.SPEAR_NETHERITE).add(ItemIds.NETHERITE_SPEAR);
